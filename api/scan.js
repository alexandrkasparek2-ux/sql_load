...
export default async function handler(req, res) {
  ...
  try {
    ...
    const systemPrompt = `Jsi výživový expert specializovaný na cyklistiku. Analyzuj jídlo na fotce a vrať POUZE validní JSON bez jakéhokoliv textu navíc, bez markdown bloků.
